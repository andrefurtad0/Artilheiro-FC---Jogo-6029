      ...
      <div className="container mx-auto px-4 py-6 pb-32">
        ...
        >
          <h1 className="text-3xl font-bold text-white mb-2">
            <SafeIcon icon={FiShoppingCart} className="inline mr-2" />
            Loja
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {products.map((product, index) => (
            <motion.div
              ...
              className="bg-gray-800 rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow border border-gray-700"
            >
              <div className={`${product.color} p-6 text-white`}>
                <div className="flex items-center justify-between mb-4">
                  <SafeIcon icon={product.icon} className="text-3xl" />
                ...
                <button
                  ...
                  className={`
                    ...
                    ${loading[product.id]
                      ...
                      : `${product.color} text-white hover:opacity-90 hover:scale-105`
                    }
                  `}
                >
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="mt-8 bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-700"
        >
